...
for j in range(1,4):
    ...
    data = np.loadtxt(f'lacc{j}.csv', delimiter=',', skiprows=1)
    ...
    sample_size = 10#variable is used to specify the number of readings that are averaged together to reduce noise in the accelerometer data.
